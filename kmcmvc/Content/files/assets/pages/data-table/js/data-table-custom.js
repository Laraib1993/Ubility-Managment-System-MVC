    ...
    $(document).ready(function() {
        ...
        $('#userinfotable').DataTable({
            ...
            aoColumns: [
                ...
                { "data": "userinfoID", "name": "userinfoID"},

                {
                    "render": function (data, type, full, meta) {
                                                                                                                        
                        return '<a type="button" data-toggle="tooltip" data-placement="bottom" title="Edit" class="btn waves-effect waves-dark btn-primary btn-outline-primary btn-icon" href="/Admin/userinfoes/Edit/' + full.userinfoID + '"><i class="icofont icofont-ui-edit"></i></a> <a type="button" data-toggle="tooltip" data-placement="bottom" title="Detail" class="btn waves-effect waves-dark btn-success btn-outline-success btn-icon" href="/Admin/userinfoes/Details/' + full.userinfoID + '"><i class="icofont icofont-sub-listing"></i></a> <a type="button" data-toggle="tooltip" data-placement="bottom" title="Delete" class="btn waves-effect waves-dark btn-danger btn-outline-danger btn-icon" href="/Admin/userinfoes/Delete/' + full.userinfoID + '"><i class="icofont icofont-ui-delete"></i></a>';
